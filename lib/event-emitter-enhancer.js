...
function enhance(EmitterType, modifyType) {
    ...
    case 0:
        ...
        EnhancedPrototype = EnhancedEventEmitter.prototype;
    ...
    case 2:
        EnhancedEventEmitter = EmitterType;
        EnhancedPrototype = EnhancedEventEmitter;

        break;
    }

    //keep original emit before replacing it with enhanced version
    var baseEmit = EnhancedPrototype.emit;
     ...
     * @public
     */
    EnhancedPrototype.suspended = false;
     ...
     */
    EnhancedPrototype.suspend = function (event) {
        if (event) {
     ...
     */
    EnhancedPrototype.unsuspend = function (event) {
     ...
     */
    EnhancedPrototype.else = function (listener) {
     ...
     */
    EnhancedPrototype.removeElseListener = function (listener) {
     ...
     * @param {ElseCallback} listener - The listener to remove
     */
    EnhancedPrototype.unelse = EnhancedPrototype.removeElseListener;  //shorter function name
     ...
     * @public
     */
    EnhancedPrototype.removeAllElseListeners = function () {
     ...
     */
    EnhancedPrototype.elseError = function (event) {
        if (event) {
     ...
     * @param {string} event - The event name
     */
    EnhancedPrototype.removeElseError = function (event) {
     ...
     * @param {string} event - The event name
     */
    EnhancedPrototype.unelseError = EnhancedPrototype.removeElseError;  //shorter function name
     ...
     */
    EnhancedPrototype.emit = function (event) {
        var emitted = false;
     ...
     */
    EnhancedPrototype.emitAsync = function () {
     ...
     */
    EnhancedPrototype.onAsync = function (event, listener) {
     ...
     */
    EnhancedPrototype.addFilter = function () {
        var self = this;
        var removeFunction = null;
     ...
     * @returns {function} The remove filter function
     */
    EnhancedPrototype.filter = EnhancedPrototype.addFilter;  //shorter function name
     ...
     */
    EnhancedPrototype.runFilterChain = function (emitArguments) {
        if (this.filters) {

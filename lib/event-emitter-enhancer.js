 ...
 */
EventEmitter.prototype.onAsync = function (event, listener) {
 ...
 */
EventEmitter.prototype.addFilter = function () {
    var self = this;
    var removeFunction = null;
 ...
 * @returns {function} The remove filter function
 */
EventEmitter.prototype.filter = EventEmitter.prototype.addFilter;  //shorter function name
 ...
 */
EventEmitter.prototype.runFilterChain = function (emitArguments) {
    if (this.filters) {
